...
<div align = "left" style ="margin: 20px; font-size: 16px;">
    <p><strong>Name:</strong> H TARUN </p>
    <p><strong>Email ID:</strong> htarung8ds@gmail.com </p>
    <p><strong>College Name:</strong> Jain Institute Of Enginnering </p>
    <p><strong>Branch/Specialization :</strong> Computer Science Engineering </p>
    <p><strong>College ID:</strong> 4JD22CS042 </p>
</div>
...
<div align="left" style="margin: 20px; font-size: 16px;">
    ...
    <p><strong>Instructor Name:</strong> PURNANGSHU NATH ROY </p>
</div>
<div align="left" style="margin: 20px; font-size: 16px;">
...
<p><strong>Trainer Name:</strong> PURNANGSHU NATH ROY </p>
<p><strong>Trainer Email ID:</strong> purnangshu13@gmail.com </p>
<p><strong>Trainer Designation:</strong> CSR BOX AS AI CONSULTANT </p>
...
<p>
  <a href="<https://github.com/tarun8055/Pizza-Sales-Report/blob/main/SURE_Trust_project_document%5BTarun%5D.docx>" target="_blank"><strong>→ View Full Project Report</strong></a>
</p>
